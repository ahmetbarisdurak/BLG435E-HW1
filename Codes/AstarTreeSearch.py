...
class AstarTreeSearch(SearchAlgorithmBase):
    ...
    def step(self):
        ...
        self._explored.insert(0, current)
        ...
        for neighbor in valid_neighbors:
            ...
            if neighbor not in [i[2] for i in self._open_set]:  # Not in open set
                ...
                if 0 < existing_node[1]:
                    ...
                    heapq.heappush(self._open_set, (0 + self._heuristic(neighbor), 0, neighbor))
